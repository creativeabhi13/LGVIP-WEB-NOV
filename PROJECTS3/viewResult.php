...
<span class="labels" style="color:yellow;">Name : <?php echo $name;?><br>Registration number: <?php echo $roll;?><br>Semester : <?php echo $sem;?></span>
...
?>
<table border="0" cellpadding="8" cellspacing="8" class="design">
<tr><td class="labels" style="color:blue;">Subject</td><td class="labels" style="color:blue;">Marks</td></tr>
